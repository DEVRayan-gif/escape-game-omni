...
Ce projet est un site web sur le thème d'un escape game nocturne immersif. Il permet de découvrir le concept du jeu, consulter les infos pratiques, réserver une session et, côté administration, de gérer les inscriptions, les commentaires et les scores des équipes.
